...
import {
  createBarRaceChartOptions,
  getBarRaceChartLifeExpectancyData,
} from '../../../chart-options/bar-race-chart';
...
export class BarRaceChartComponent
  ...
  implements AfterViewInit
{
  ...
  constructor() {
    ...
    const { options, startYear, startIndex, years, updateFrequency } =
      createBarRaceChartOptions();
