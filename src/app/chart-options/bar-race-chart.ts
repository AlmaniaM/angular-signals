...
export const createBarRaceChartOptions: () => BarRaceData = () => {
  const flags = getBarRaceChartData();
  const data = getBarRaceChartLifeExpectancyData();
  const years = [];
      ...
      series: [
        {
          ...
          itemStyle: {
            color: (param: any) => {
              const colors = countryColors as { [key: string]: any }
              return colors[(param.value as any)[3]] || '#5470c6';
            },
          },
          encode: {
            x: dimension,
...
export const getBarRaceChartLifeExpectancyData = () => [
  [
      "Income",
      "Life Expectancy",
      "Population",
...
export const getBarRaceChartData = () => [
  {
      "code": "AD",
      "emoji": "🇦🇩",
